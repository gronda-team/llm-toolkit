...
const openAIToolkit = () => {
  ...
  const gptModels = {
    ...
    ["gpt-4-turbo-preview"]: defineModel<OpenAIGptModelSettings>({
      promptCostPer1000Tokens: 0.01,
      completionsCostPer1000Tokens: 0.03,
      maxTokens: 128000,
    }),
    ...
    ["gpt-4o"]: defineModel<OpenAIGptModelSettings>({
      promptCostPer1000Tokens: 0.005,
      completionsCostPer1000Tokens: 0.015,
      maxTokens: 128000,
    }),
    ["gpt-4o-2024-05-13"]: defineModel<OpenAIGptModelSettings>({
      promptCostPer1000Tokens: 0.005,
      completionsCostPer1000Tokens: 0.015,
      maxTokens: 128000,
    }),
    ...
    ["gpt-4o-mini-2024-07-18"]: defineModel<OpenAIGptModelSettings>({
      promptCostPer1000Tokens: 0.00015,
      completionsCostPer1000Tokens: 0.0007,
      maxTokens: 128000,
    }),
  };
